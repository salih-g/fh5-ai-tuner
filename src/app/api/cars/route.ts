      ...
      data: {
        ...
        performance: {
          create: {
            ...
            aspiration: validatedData.performance.aspiration,
            enginePosition: validatedData.performance.enginePosition,
            rearWeight: validatedData.performance.rearWeight,
            cylinders: validatedData.performance.cylinders,
            stockAccel: validatedData.performance.stockAccel,
            stockTopSpeed: validatedData.performance.stockTopSpeed,
          },
        },
      },
      include: {
